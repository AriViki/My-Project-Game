...
nyawa_user = 3 #nyawa user

#variabel untuk alien
y_peluru_alien_kanan = 0 #gerak peluru alien kanan kebawah
y_peluru_alien_tengah = 0 #gerak peluru alien tengah kebawah
y_peluru_alien_kiri = 0 #gerak peluru alien kiri kebawah
point_kanan = 0 #kondisi awal alien kanan atau bisa dijadikan sebagai nyawa alien kanan
point_tengah = 0 #kondisi awal alien tengah atau bisa dijadikan sebagai nyawa alien tengah
point_kiri = 0 #kondisi awal alien kiri atau bisa dijadikan sebagai nyawa alien kiri
mode_alien_kanan = 0 #kondisi jika tampilan alien kanan didalam window
mode_alien_tengah = 0 #kondisi jika tampilan alien tengah didalam window
mode_alien_kiri = 0 #kondisi jika tampilan alien kiri didalam window
alien_hancur = 100 #jarak geser pesawat alien keatas sehingga keluar dari window
